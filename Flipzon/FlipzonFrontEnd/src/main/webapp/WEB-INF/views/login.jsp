...
<body>
<!-- We are going to design a simple html form with the following two input elements textboxes having the
names as
							...
							<div class="panel-body">
								<form action="${contextRoot}/login" method="POST"
									...
									<div class="form-group">
										...
										<!-- provide an hidden field that will keep the csrf token that only server recognize when the form is submitted -->
