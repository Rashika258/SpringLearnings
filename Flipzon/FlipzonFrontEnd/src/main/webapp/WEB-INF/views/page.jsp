...
<meta name="author" content="Rashika Suresh">

<!-- For ajax request we need to send csrf token along with the request for that we will save the token inside
the meta tag. -->
...
<body>
	...
	<div class="wrapper">
		...
		<div class="content">
			...
			<!-- Load only when user clicks manage product -->
			<c:if test="${userClicksShowCart == true}">
